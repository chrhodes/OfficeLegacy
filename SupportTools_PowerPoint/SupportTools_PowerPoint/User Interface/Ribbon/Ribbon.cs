...
namespace SupportTools_PowerPoint
{
    public partial class Ribbon
    {
        ...
        private void btnComplianceUtilities_Click(object sender, RibbonControlEventArgs e)
        {
            ...
            {
                Common.TaskPaneComplianceUtil = AddinHelper.TaskPaneUtil.AddTaskPane(new User_Interface.Task_Panes.TaskPane_ComplianceUtil(), "Compliance Utilities", Globals.ThisAddIn.CustomTaskPanes);
        ...
        private void btnSharePointUtilities_Click(object sender, RibbonControlEventArgs e)
        {
            if (Common.TaskPaneSharePointInfo == null)
            {
                Common.TaskPaneSharePointInfo = AddinHelper.TaskPaneUtil.AddTaskPane(new User_Interface.Task_Panes.TaskPane_SharePointInfo(), "SharePoint Info", Globals.ThisAddIn.CustomTaskPanes);
                Common.TaskPaneSharePointInfo.Width = Common.TaskPaneSharePointInfo.Control.Width;
            }
            else
            {
                Common.TaskPaneSharePointInfo.Visible = !Common.TaskPaneSharePointInfo.Visible;
            }
        }
