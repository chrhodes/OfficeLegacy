...
namespace SharePointAdministration
{
    /// <summary>
    /// ConfigData
    /// 
    ...
    /// 
    /// To use this class, 
    /// 1. Add code in the Reload() method of the intial UserControl to store the ConfigData
    ...
    {
        // TODO: Update this with the root element in the configuration data.
        ...
        public static IEnumerable<XElement> DefaultViews
        {
            get
            {
                return GetDescendantElements(_RootElementName, "DefaultView");
            }
        }

        public static IEnumerable<XElement> DefaultLists
        {
            get
            {
                return GetDescendantElements("DefaultLists", "List");
            }
        }

        #region Template Sample

        // Cat, Dog, and NorthWindDBConnectionString
        ...
        //    get
        //    {
        //        string configElement = "Cat";

        //        if(_cat.Length == 0)
        //        {
        //            _cat = GetElementValue("AppConfigData", configElement);

        //            if(0 == _cat.Length)
        //            {
        //                MessageBox.Show(
        //                    string.Format("{0}.  Could not find {1} in <AppConfigData>.",
        //                        System.Reflection.MethodInfo.GetCurrentMethod().Name, configElement), "ConfigData Error", MessageBoxButtons.OK);
        //            }
        //        }
        ...
        //    get
        //    {
        //        string configElement = "Dog";

        //        if(_dog.Length == 0)
        //        {
        //            _dog = GetElementValue("AppConfigData", configElement);
        ...
        //    get
        //    {
        //        string configElement = "NorthWindDBConnection";

        //        if(_northWindDBConnectionString.Length == 0)
        //        {
        //            _northWindDBConnectionString = GetElementValue("AppConfigData", configElement);

        //            if(0 == _northWindDBConnectionString.Length)
        //            {
        //                MessageBox.Show(
        //                    string.Format("{0}.  Could not find {1} in <AppConfigData>.",
        //                        System.Reflection.MethodInfo.GetCurrentMethod().Name, configElement), "ConfigData Error", MessageBoxButtons.OK);
        ...
        //        return _northWindDBConnectionString;
        //    }
        //    set
        //    {
        //        _northWindDBConnectionString = value;
        ...
        private static IEnumerable<urlinfo> GetUrlList(string root, string param)
        {
            ...
            if(RawXML == null)
            {
                MessageBox.Show("Error GetUrlList(). ConfigData has not been loaded in Reload() yet.", "Config Data Error", MessageBoxButtons.OK);
                return urls;
            }
        ...
        internal static string PopulateConfigValue(string configElement, ref string backingVariable)
        {
            if(null == backingVariable)
            {
                MessageBox.Show(
                    ...
                    "ConfigData Error", MessageBoxButtons.OK);
                return "";
            }
        ...
        internal static XElement GetDescendantElement(string descendantName, string elementName)
        {
            if(RawXML == null)
            {
                MessageBox.Show("Error GetParameter(). ConfigData has not been loaded in Reload() yet.", "Config Data Error", MessageBoxButtons.OK);
                return null;
            }
