...
Public NotInheritable Class Common
    Public Const PROJECT_NAME As String = "SupportToolsProject"
    ...
    'Public Shared ProjectHelper As New ProjectHelper.ProjectHelper
...
#Region "Task Panes"
    ...
    Public Shared Property TaskPaneProjectUtil() As Microsoft.Office.Tools.CustomTaskPane
