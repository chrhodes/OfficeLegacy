...
Public Class VisioAppEvents
    ...
    Private Const cMODULE_NAME As String = Globals.PROJECT_NAME & ".VisioAppEvents"

    Private Shared Sub DisplayInWatchWindow(ByVal outputLine As String)
        Dim watchWindow As AddinHelper.WatchWindow = Globals.ThisAddIn.AppEventsWatchWindow

        If Not watchWindow Is Nothing Then
            watchWindow.AddOutputLine(outputLine)
        End If
    End Sub
