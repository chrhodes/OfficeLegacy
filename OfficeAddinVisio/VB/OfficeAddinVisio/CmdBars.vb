...
Public Class CmdBars
    ...
    Private Sub CreateApplicationToolbar()
        ...
        Try
            ...
            Dim _Visio_WatchWindow As Visio_WatchWindow = New Visio_WatchWindow(_AppToolbar, MsoButtonStyle.msoButtonIcon)
...
#Region "Local Application Commands"
    ...
    Private Sub AddLocalCommands()
        ...
        ' Add commands to our toolbar.  These commands are not normally
