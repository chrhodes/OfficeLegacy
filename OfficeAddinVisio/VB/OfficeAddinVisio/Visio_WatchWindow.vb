...
Public Class Visio_WatchWindow
    Inherits AddinHelper.AppMethod

#Region "Private Variables"

    Private Const _MODULE_NAME As String = Globals.PROJECT_NAME & "Visio_WatchWindow"
    Private Const _NAME As String = "Visio_WatchWindow"
    Private Const _BITMAP_NAME As String = "WatchWindow.bmp"
    Private Const _CAPTION As String = "Visio_WatchWindow"
    Private Const _TOOL_TIP_TEXT As String = "Click for Visio_WatchWindow"
    Private Const _DESCRIPTION As String = "Visio_WatchWindow does ..."
