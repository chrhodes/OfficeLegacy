...
''' </remarks>
Public Class Office_Action
    Inherits AddinHelper.AppMethod

#Region "Private Constants and Variables"

    Private Const _MODULE_NAME As String = Common.PROJECT_NAME & "Office_Action"
    Private Const _NAME As String = "Office_Action"
    Private Const _BITMAP_NAME As String = "ActionName.bmp"
    Private Const _CAPTION As String = "Office_Action"
    Private Const _TOOL_TIP_TEXT As String = "Click for Office_Action"
    Private Const _DESCRIPTION As String = "Office_Action does ..."
