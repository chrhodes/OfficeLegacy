...
#Region "Event Hanlders"
    ...
    Private Sub btnWordUtilities_Click(ByVal sender As System.Object, ByVal e As Microsoft.Office.Tools.Ribbon.RibbonControlEventArgs) Handles btnWordUtilities.Click, btnWorkUtilities.Click
        If Common.TaskPaneWordUtil Is Nothing Then
            Common.TaskPaneWordUtil = AddinHelper.TaskPaneUtil.AddTaskPane(New TaskPane_WordUtil, "WordUtil", Globals.ThisAddIn.CustomTaskPanes)
        Else
