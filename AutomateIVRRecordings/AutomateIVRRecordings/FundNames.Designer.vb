...
Partial Public NotInheritable Class FundNames
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _FundNames As FundNames

    Friend Shared Property FundNames() As FundNames
        Get
            Return _FundNames
        End Get
        Set(ByVal value As FundNames)
            If (_FundNames Is Nothing) Then
                _FundNames = value
            Else
