...
''' </remarks>
Public Class Excel_ProtectSheets
    Inherits AddinHelper.AppMethod

#Region "Private Constants and Variables"

    Private Const _MODULE_NAME As String = Common.PROJECT_NAME & "Excel_ProtectSheets"
    Private Const _NAME As String = "Excel_ProtectSheets"
    Private Const _BITMAP_NAME As String = "protect sheets.bmp"
    Private Const _CAPTION As String = "Protect Sheets"
    Private Const _TOOL_TIP_TEXT As String = "Protect all worksheets"
    Private Const _DESCRIPTION As String = "Excel_ProtectSheets does ..."
...
#Region "Public Methods"
    ...
    Public Shared Sub ProtectSheets()
