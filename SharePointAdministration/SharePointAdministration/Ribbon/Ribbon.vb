...
<ComVisible(True)> _
    ...
    Public Function GetCustomUI(ByVal ribbonID As String) As String Implements Office.IRibbonExtensibility.GetCustomUI
        Return GetResourceText("SharePointAdministration.Ribbon.xml")
    End Function
...
#Region "Ribbon Callbacks"
    ...
    Private _TaskPane_One_Exists As Boolean = False

    Public Sub TaskPane_One_Click(ByVal control As Office.IRibbonControl)
        If Not _TaskPane_One_Exists Then
            Globals.ThisAddIn.AddTaskPane_One()
        Else
            Globals.ThisAddIn.RemoveTaskPane_One()
        End If

        _TaskPane_One_Exists = Not _TaskPane_One_Exists
    End Sub
#End Region
