...
#Region "Event Handlers"
    ...
    Private Sub btnAddListObjects_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddListObjects.Click
        AddListObjects()
    End Sub

    Private Sub btnAddPageBreaks_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPageBreaks.Click
        AddPageBreaks()
    End Sub

    Private Sub btnAddPivotTables_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPivotTables.Click
    ...
    Private Sub btnMergeDuplicateRows_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMergeDuplicateRows.Click
        MergeDuplicateRows()
    End Sub

    Private Sub btnProcessDARTOutput_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcessDARTOutput.Click
    ...
    Private Sub btnProcessDuplicateRow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcessDuplicateRows.Click
        ProcessDuplicates()
    End Sub

    Private Sub btnProcessDynamicOutput_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcessDynamicOutput.Click
        ProcessDynamicOutput()
    End Sub

    Private Sub cmbTeamName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbTeamName.SelectedIndexChanged
...
#Region "Main Function Routines"
    ...
    Private Function GetDefaultOutputFileName() As String
    ...
    Private Sub DisplayITRDetail()
        Try
            Dim currentRow As Integer = Globals.ThisAddIn.Application.ActiveCell.Row
            Dim itrID As Integer = Globals.ThisAddIn.Application.ActiveSheet.Cells(currentRow, 1).Value
    ...
    Private Shared Sub DuplicateInputSheet()
        ...
        End With
    End Sub
    Private Sub btnDuplicateInputSheet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDuplicateInputSheet.Click
        DuplicateInputSheet()
    End Sub

    Private Sub btnFormatSourceITRs_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFormatSourceITRs.Click
        FormatSourceITRs()
    End Sub
    ...
    Private Sub GetITRInformation()
        ...
        'Dim ta As ApplicationDSTableAdapters.sp_ITRDetailTableAdapter = New ApplicationDSTableAdapters.sp_ITRDetailTableAdapter()
        Dim itrDataRow As ApplicationDS.sp_ITRDetailRow = Nothing
        'Dim itrDataTable As ApplicationDS.sp_ITRDetailDataTable
...
#Region "Pivot Table Routines"
    ...
    Sub AddPivotTable_PivotByPatRank()
        ''Dim newSheet As Excel.Worksheet
        Dim pivotTableName As String
        ''Dim pivotTableDestination As String
        Dim sourceData As String
        Dim pivotTableHeader As String

        pivotTableName = "ITRByApplicationPatRank"
        pivotTableHeader = "ITR by Application Pat Rank"
        sourceData = "SourceITRInfo"

        PivotTable_Create(pivotTableName, pivotTableHeader, sourceData)

        With Globals.ThisAddIn.Application
            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("Application")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 1
            End With

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("PAT Rank")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 2
            End With

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("ITR ID")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 3
            End With

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("Subject")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 4
            End With
        End With
    ...
    Sub AddPivotTable_PivotByResource()
        'Dim newSheet As Excel.Worksheet
        Dim pivotTableName As String
        'Dim pivotTableDestination As String
        Dim sourceData As String
        ...
        pivotTableName = "ITRByResource"
        pivotTableHeader = "ITR by Resource"
        sourceData = "SourceITRResourceInfo"
        ...
        With Globals.ThisAddIn.Application
            ...
            '    pivotTableName).PivotFields("Resource ID"), "Count", Excel.XlConsolidationFunction.xlCount)

            .ActiveSheet.PivotTables(pivotTableName).AddDataField(.ActiveSheet.PivotTables( _
                pivotTableName).PivotFields("Application"), "Count", Excel.XlConsolidationFunction.xlCount)

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("Resource ID")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 1
            End With
            ...
            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("Status")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 5
            End With

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("LOE")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 6
            End With

            With .ActiveSheet.PivotTables(pivotTableName).PivotFields("Age")
                .Orientation = Excel.XlPivotFieldOrientation.xlRowField
                .Position = 7
            End With
        End With
    ...
    Sub AddPivotTable_PivotByApplicationStatus()
        'Dim newSheet As Excel.Worksheet
        Dim pivotTableName As String
        'Dim pivotTableDestination As String
        Dim sourceData As String
        ...
        pivotTableName = "ITRByApplicationStatus"
        pivotTableHeader = "ITR by Application Status"
        sourceData = "SourceITRInfo"
        ...
        With Globals.ThisAddIn.Application
            .ActiveSheet.PivotTables(pivotTableName).AddDataField(.ActiveSheet.PivotTables( _
                pivotTableName).PivotFields("Status"), "Count", Excel.XlConsolidationFunction.xlCount)
    ...
    Private Sub AddPivotTable_PivotByStatusApplication()
        'Dim newSheet As Excel.Worksheet
        Dim pivotTableName As String
        'Dim pivotTableDestination As String
        Dim sourceData As String
        ...
        pivotTableName = "ITRByStatusApplication"
        pivotTableHeader = "ITR by Status Application"
        sourceData = "SourceITRResourceInfo"
    ...
    Sub MoveITRCommentsBelow()
        Dim currentCell As Excel.Range
        Dim currentRow As Integer

        ' TODO: Add a constant for this 
        currentRow = 7  ' Second ITR

        With Globals.ThisAddIn.Application
            currentCell = .Cells(currentRow, 1)
            ...
            ' Dp one more as we reach backward for the data for the last ITR.
    ...
    Sub PivotTable_CollapseSections(ByVal pivotTableName As String, ByVal fieldName As String)
    ...
    Sub PivotTable_Create(ByVal pivotTableName As String, ByVal pivotTableHeader As String, ByVal sourceData As String)
        Dim newSheet As Excel.Worksheet
        Dim pivotTableDestination As String
        ...
        With Globals.ThisAddIn.Application
            ...
            .ActiveWorkbook.PivotCaches.Create( _
                ...
                Version:=Excel.XlPivotTableVersionList.xlPivotTableVersion12).CreatePivotTable( _
                    TableDestination:=pivotTableDestination, _
                    TableName:=pivotTableName, _
                    DefaultVersion:=Excel.XlPivotTableVersionList.xlPivotTableVersion12)

            .ActiveSheet.PivotTables(pivotTableName).CompactLayoutRowHeader = pivotTableHeader
        End With
    End Sub
