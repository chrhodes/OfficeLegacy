...
''' </remarks>
Public Class Excel_AllLandscape
    Inherits AddinHelper.AppMethod

#Region "Private Constants and Variables"

    Private Const _MODULE_NAME As String = Common.PROJECT_NAME & "Excel_AllLandscape"
    Private Const _NAME As String = "Excel_AllLandscape"
    Private Const _BITMAP_NAME As String = "format all landscape.bmp"
    Private Const _CAPTION As String = "Format Landscape"
    Private Const _TOOL_TIP_TEXT As String = "All worksheets Landscape"
    Private Const _DESCRIPTION As String = "Excel_AllLandscape does ..."
...
#Region "Public Methods"
    ...
    Public Shared Sub AllLandscape()
