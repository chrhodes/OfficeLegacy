...
''' </remarks>
Public Class Excel_UngroupSelection
    Inherits AddinHelper.AppMethod

#Region "Private Constants and Variables"

    Private Const _MODULE_NAME As String = Common.PROJECT_NAME & "Excel_UngroupSelection"
    Private Const _NAME As String = "Excel_UngroupSelection"
    Private Const _BITMAP_NAME As String = "ungroup selection.bmp"
    Private Const _CAPTION As String = "Ungroup Selection"
    Private Const _TOOL_TIP_TEXT As String = "Ungroup Selection"
    Private Const _DESCRIPTION As String = "Excel_UngroupSelection does ..."
...
#Region "Public Methods"
    ...
    Public Shared Sub UnGroupSelection()
