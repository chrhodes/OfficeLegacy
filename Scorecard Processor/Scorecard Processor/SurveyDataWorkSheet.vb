...
Public Class SurveyDataWorkSheet
    ...
    Public Shared Sub AddFormulas()
        ...
        Util.ProtectSheet(ws, currentProtectionMode)
    ...
    Public Shared Function CreateWorksheet(ByVal sheetName As String) As Excel.Worksheet
        ...
        With ws
            ...
            endDataRow = Util.FindLastRow(.Range("$A$30"))
            ...
            endDataColumn = Util.FindLastColumn(.Range("$A$30"))
    ...
    Public Shared Sub FormatWorksheet()
        ...
        currentProtectionMode = Util.ProtectSheet(sht, False)
        Util.ScreenUpdatesOff()
        ...
        Util.ProtectSheet(sht, currentProtectionMode)
        Util.ScreenUpdatesOn()
    ...
    Public Shared Sub LoadSurveyDataFromMDBFile()
        ...
        Dim inputFile As String = Util.GetFile(Globals.cDEFAULT_SURVEY_FOLDER, "Select File Containing Survey Data", "Survey Data Files (*.MDB)|*.MDB")
