...
Public Class YWorkSheet
    ...
    Public Shared Function CreateWorkSheet(ByVal sheetName As String) As Excel.Worksheet
        ...
        'With ws
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 0, 15, startRow, "IT Team", _
        '        headerFontSize, headerBold, headerUnderline, headerWrapText, headerHorizontalAlignment)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 1, 15, startRow, "Open ITRs", _
        '        headerFontSize, headerBold, headerUnderline, headerWrapText, headerHorizontalAlignment)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 2, 15, startRow, "Closed ITRs", _
        '        headerFontSize, headerBold, headerUnderline, headerWrapText, headerHorizontalAlignment)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 3, 15, startRow, "Active ITRs", _
        '        headerFontSize, headerBold, headerUnderline, headerWrapText, headerHorizontalAlignment)
