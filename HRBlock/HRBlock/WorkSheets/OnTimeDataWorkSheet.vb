...
#Region "AddFormulas"
    ...
    Public Shared Sub AddFormulas( _
        ...
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 7), "Average On Time Delivery", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 8), "Total Actual Release Days", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 9), "% of Total Actual Release Days", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 10), "Weighted Actual On Time Delivery", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 11), "Total Scheduled Release Days", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 12), "% of Total Scheduled Release Days", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
        '            Globals.ThisAddIn.ExcelUtil.AddContentToCell(.Cells(columnHeadingsRow, 13), "Weighted Scheduled On Time Delivery", _
        '                8, Globals.MakeBold.Yes, Globals.UnderLine.No, Globals.WrapText.Yes, Excel.XlHAlign.xlHAlignCenter)
