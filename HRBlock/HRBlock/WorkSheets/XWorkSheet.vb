...
Public Class XWorkSheet
    ...
    Public Shared Function CreateWorkSheet(ByVal sheetName As String) As Excel.Worksheet
        ...
        'ws = Globals.ThisAddIn.ExcelUtil.NewWorksheet(sheetName)

        '' TODO: Get rid of the magic constants and booleans.
        'With ws
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 0, 15, False, startRow, "Team", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 1, 15, False, startRow, "Score", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 2, 15, True, startRow, "On-Time % (Scheduled Weighted)", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 3, 15, True, startRow, "On-Time % (Actual Weighted)", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 4, 12, True, startRow, "On-Time % (Average)", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 5, 12, False, startRow, "# Releases", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 6, 17, False, startRow, "Manager", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 7, 11, False, startRow, "Extension", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 8, 85, False, startRow, "Source File (Full Path)", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 9, 15, False, startRow, "SheetName", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 10, 15, False, startRow, "File Errors", headerFontSize, headerBold, headerUnderline)
        '    Globals.ThisAddIn.ExcelUtil.AddColumnToSheet(ws, startCol + 11, 25, False, startRow, "Data Sheet Name", headerFontSize, headerBold, headerUnderline)
